...
The application is under active development and is intended for testing with an Elecraft K4/K4D on the same network. Version 0.7.5 is available as a release-signed ARM64 APK.
